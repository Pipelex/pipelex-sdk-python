...
| `pipe_io_contracts` | `PipeIOContracts \| None` | the `pipe_io_contracts.json` artifact, once relayed | lifted off `pipe_output` |
| `input_form` | `InputForm \| None` | the `input_form.json` artifact, once relayed | lifted off `pipe_output` |
| `output_form` | `OutputForm \| None` | the `output_form.json` artifact, once relayed | lifted off `pipe_output` |
